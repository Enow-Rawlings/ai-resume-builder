...
const updateEducation = (index, field, value)=>{
    ...
    return (
        ...
        <div className="flex items-center justify-between">
            ...
            <button onClick={addEducation} className="flex items-center gap-2 px-3 py-1 text-sm bg-green text-green-700 rounded-lg hover:bg-green-200 transition-colors">
                    ...
                    {data.map((education, index)=> (
                        <div key={index} className="p-4 border boder-gray-200 rounded-lg space-y-3">
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                ...
                                <input value={education.gpa || ""} onChange={(e)=> updateEducation(index, "gpa", e.target.value)} type="text" disabled={education.is_current} className="px-3 py-2 text-sm" placeholder='GPA (optional)' />
