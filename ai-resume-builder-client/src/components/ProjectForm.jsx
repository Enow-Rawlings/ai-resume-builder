...
//             </div>
//             <button onClick={addProject} className="flex items-center gap-2 px-3 py-1 text-sm bg-green text-green-700 rounded-lg hover:bg-green-200 transition-colors">
...
//                                 <textarea rows={4} value={project.description || ""} onChange={(e)=> updateEducation(index, "description", e.target.value)} placeholder="Describe your project..." className="px-3 py-2 text-sm rounded-lg"/>
//                                 </div>
                    ...
                    <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                        ...
                        <div className="grid gap-3">
                            ...
                            <textarea 
                                ...
                                // ✅ FIXED: Changed updateEducation to updateProject
                                onChange={(e) => updateProject(index, "description", e.target.value)} 
                                placeholder="Describe your project..." 
                                className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 resize-none"
                            />
                        </div>
                    </div>
                ))}
