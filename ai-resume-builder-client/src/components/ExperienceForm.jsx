import { Briefcase, Loader, Loader2, Plus, Trash, Sparkles } from "lucide-react";
...
const generateDescription = async (index) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <button onClick={addExperience} className="flex items-center gap-2 px-3 py-1 text-sm bg-green text-green-700 rounded-lg hover:bg-green-200 transition-colors">
